...
pub(crate) const LATE_ATTACH_GHOSTSNP_CORE_PIN: &str = "2c5171a6cb3b073c53620a9838d8b08480dd215c";
...
pub(crate) const LATE_ATTACH_HISTORY_PAYLOAD: &[u8] =
...
pub(crate) const LATE_ATTACH_HISTORY_PAYLOAD_LEN: usize = 1176;
...
pub(crate) const LATE_ATTACH_NO_HISTORY_PAYLOAD: &[u8] =
    include_bytes!("../fixtures/ghostsnp/late-attach-blank-v1.ghostsnp");
pub(crate) const LATE_ATTACH_NO_HISTORY_PAYLOAD_LEN: usize = 1157;

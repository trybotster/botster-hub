...
/// Core pin used to generate incremental late-attach GHOSTSNP frames.
pub(crate) const LATE_ATTACH_GHOSTSNP_CORE_PIN: &str = "033cd01ca307e57fb9fd8c8b6deadb6d691ab45b";
...
/// Incremental history READY frame generated by `GhosttyTerminal::export_snapshot_frames`.
pub(crate) const LATE_ATTACH_HISTORY_READY_PAYLOAD: &[u8] =
    include_bytes!("../fixtures/ghostsnp/late-attach-history-ready-v2.ghostsnp");
...
/// Incremental history PAGE frame from the same encoder run.
pub(crate) const LATE_ATTACH_HISTORY_PAGE_PAYLOAD: &[u8] =
    include_bytes!("../fixtures/ghostsnp/late-attach-history-page-v2.ghostsnp");
...
/// Incremental history FINISH frame from the same encoder run.
pub(crate) const LATE_ATTACH_HISTORY_FINISH_PAYLOAD: &[u8] =
    include_bytes!("../fixtures/ghostsnp/late-attach-history-finish-v2.ghostsnp");
...
/// Incremental blank READY frame from a 24×80 terminal with zero writes.
pub(crate) const LATE_ATTACH_NO_HISTORY_READY_PAYLOAD: &[u8] =
    include_bytes!("../fixtures/ghostsnp/late-attach-blank-ready-v2.ghostsnp");
...
/// Incremental blank FINISH frame from the same encoder run.
pub(crate) const LATE_ATTACH_NO_HISTORY_FINISH_PAYLOAD: &[u8] =
    include_bytes!("../fixtures/ghostsnp/late-attach-blank-finish-v2.ghostsnp");

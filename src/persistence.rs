//! Profile-owned persistence policy seam.
//!
//! Persistence choices for host-profile state, package state, and provider
//! state are profile policy. This scaffold defines the buckets without
//! selecting a database or storage implementation.

...
assert.equal(metadata.package_version, "0.1.34");
assert.equal(metadata.protocol, "botster-hub-daemon-v1");
assert.equal(metadata.protocol_version, 7);
assert.equal(metadata.conformance_fixture_revision, 39);
...
assert.equal(sessionLifecycleFixture.conformance_fixture_revision, 39);
...
assert.equal(sessionPluginBindingFixture.conformance_fixture_revision, 39);
...
assert.equal(lateAttachFixture.conformance_fixture_revision, 39);

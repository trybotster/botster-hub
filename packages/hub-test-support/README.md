...
After `@trybotster/hub-test-support@0.1.18` is published to the public npm
...
Version 0.1.18 is prepared in this repository; it is not published by this
change. Version 0.1.17 was published with stale protocol bytes and is not a
valid consumer coordinate. Version 0.1.18 carries protocol version 4 /

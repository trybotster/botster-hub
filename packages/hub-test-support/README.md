...
Use this command for version 0.1.35:

```sh
npm install --save-dev @trybotster/ui-contract@0.3.2 @trybotster/hub-test-support@0.1.35
```
...
`@trybotster/hub-test-support@0.1.35` carries byte-faithful live
`terminal_output` payloads (`payload_base64`, `payload_encoding`, `bytes`)
and authentic dual GHOSTSNP late-attach fixtures (conformance revision 40).

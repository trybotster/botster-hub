...
Use this command for version 0.1.37:

```sh
npm install --save-dev @trybotster/ui-contract@0.3.2 @trybotster/hub-test-support@0.1.37
```
...
{
  "devDependencies": {
    "@trybotster/hub-test-support": "0.1.37"
  }
}
```

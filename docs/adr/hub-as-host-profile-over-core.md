...
- Documentation outpacing enforcement: the north-star boundary is already
  clearer than all package/runtime enforcement. Mitigation: document first, then
  audit seams, then enforce with tests and package layout once current surfaces
  agree.

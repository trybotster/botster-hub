...
| Global worker-readiness race | `spawn_capture_lock` + **reject foreign worktree executables** (`executable_from_this_worktree`); never host-global new-PID fallback; 3× default-concurrency green |
